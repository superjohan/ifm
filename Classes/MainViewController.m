...
- (void)viewDidLoad
{
	...
	NSString *introText = [NSString stringWithFormat:@"Intergalactic FM for iPhone version %@ — https://www.intergalactic.fm/ — Developed by Aero Deko and IFM dev corps — Visit our site at http://aerodeko.com/", version];
